...
import com.alibaba.cloud.ai.headless.common.jsqlparser.FieldExpression;
...
public class DimValueAspect {
    ...
    @Around("execution(* com.alibaba.cloud.ai.headless.server.facade.service.SemanticLayerService.queryByReq(..))")
