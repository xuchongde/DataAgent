...
import com.alibaba.cloud.ai.headless.api.pojo.request.DataSetFilterReq;
...
import com.alibaba.cloud.ai.headless.server.manager.DimensionYamlManager;
import com.alibaba.cloud.ai.headless.server.manager.MetricYamlManager;
import com.alibaba.cloud.ai.headless.server.manager.ModelYamlManager;
...
import com.alibaba.cloud.ai.headless.server.service.*;
import com.alibaba.cloud.ai.headless.server.utils.DataSetSchemaBuilder;
import com.alibaba.cloud.ai.headless.server.utils.DimensionConverter;
import com.alibaba.cloud.ai.headless.server.utils.MetricConverter;
import com.alibaba.cloud.ai.headless.server.utils.StatUtils;
...
import static com.alibaba.cloud.ai.headless.common.pojo.Constants.AT_SYMBOL;

@Slf4j
@Service
public class HeadlessSchemaServiceImpl implements HeadlessSchemaService {
    ...
    public HeadlessSchemaServiceImpl(ModelService modelService, DimensionService dimensionService,
