 ...
 */
package com.alibaba.cloud.ai.headless.server.facade.service.impl;
...
import com.alibaba.cloud.ai.headless.common.pojo.enums.TaskStatusEnum;
...
import com.alibaba.cloud.ai.headless.core.translator.SemanticTranslator;
import com.alibaba.cloud.ai.headless.core.translator.TranslatorConfig;
import com.alibaba.cloud.ai.headless.core.utils.ComponentFactory;
import com.alibaba.cloud.ai.headless.server.annotation.S2DataPermission;
import com.alibaba.cloud.ai.headless.server.facade.service.SemanticLayerService;
import com.alibaba.cloud.ai.headless.server.manager.SemanticSchemaManager;
import com.alibaba.cloud.ai.headless.server.service.*;
import com.alibaba.cloud.ai.headless.server.utils.MetricDrillDownChecker;
import com.alibaba.cloud.ai.headless.server.utils.QueryUtils;
...
public class S2SemanticLayerService implements SemanticLayerService {
    ...
    public S2SemanticLayerService(StatUtils statUtils, QueryUtils queryUtils,
                                  ...
                                  HeadlessSchemaService schemaService, SemanticTranslator semanticTranslator,
